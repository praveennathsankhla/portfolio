...
const FirstPage = () => {
    return (
        <div className='justify-center items-center flex h-screen gap-10 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 flex-row'>
            <a href="/projects" className="hover:text-white transition inline-flex  justify-center items-center gap-2 h-20 w-60
                       ...
                       px-6 py-3 rounded-lg bg-black text-white
                        ...
                        <a href="/home" className="hover:text-white transition inline-flex items-center gap-3
